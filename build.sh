#!/bin/bash
#
# I shamelessly stole and modified this from https://gist.github.com/eduncan911/68775dba9d3c028181e4 - Ethan <('_')>
#
...
# While not needed for cross-compilation of this script, your users will need to ensure
...
OUTPUT=bin # if no src file given, use current dir name
